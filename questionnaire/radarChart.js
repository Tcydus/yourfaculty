...
function RadarChart(id, data, options) {
	...
	var cfg = {
	 ...
	 maxValue: 0, 				//What is the point that the biggest circle will represent
	...
	var radarLine = d3.svg.line.radial()
		...
		.radius(function(d) { return rScale(d.point); })
	...
	blobWrapper.selectAll(".radarCircle")
		...
		.attr("cx", function(d,i){ return rScale(d.point) * Math.cos(angleSlice*i - Math.PI/2); })
		.attr("cy", function(d,i){ return rScale(d.point) * Math.sin(angleSlice*i - Math.PI/2); })
